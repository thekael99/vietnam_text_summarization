...
PRETRAINED_VOCAB_ARCHIVE_MAP = {
    ...
    'FPTAI/vibert-base-cased': 'https://huggingface.co/FPTAI/vibert-base-cased/raw/main/vocab.txt',
    'vinai/phobert-base': 'https://huggingface.co/vinai/phobert-base/blob/main/vocab.txt',
    'NlpHUST/vibert4news-base-cased': 'https://huggingface.co/NlpHUST/vibert4news-base-cased/resolve/main/vocab.txt',
}
PRETRAINED_VOCAB_POSITIONAL_EMBEDDINGS_SIZE_MAP = {
    ...
    'FPTAI/vibert-base-cased': 512,
    'vinai/phobert-base': 512,
    'NlpHUST/vibert4news-base-cased': 512,
}
VOCAB_NAME = 'vocab.txt'


def format_special_tokens(tokenizer):
